...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-[#1a1a1a]">
      ...
      {mobileOpen && (
        <div
          className="md:hidden bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#1a1a1a] animate-fadeIn overflow-y-auto overscroll-contain"
          ...
          <div className="px-6 py-6 flex flex-col gap-5">
            {navItems.map((item) => (
              <Link
                ...
                className={`text-sm tracking-[0.15em] uppercase transition-colors py-1 ${
